            ...
            <div class="col-12">
                <div class="row d-flex justify-content-center mt-5">
                    ...
                    <div class="col col-md-3 rounded-4 p-5" style="background: #1e2833">
                        <form action="{{ route('altMenuAdd') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-5">
                                ...
                                <input type="text" class="form-control @error('altmenu') is-invalid @enderror" name="altmenu" id="altmenu" />
                                @error('altmenu')
                                    <div class="invalid-feedback">Alt Menü Giriniz</div>
                                @enderror
                            </div>
                            <div class="d-grid">
